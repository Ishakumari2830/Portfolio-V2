import { RiFirebaseFill, RiJavaFill } from "react-icons/ri";
import { TiHtml5 } from "react-icons/ti";
import { IoLogoCss3 } from "react-icons/io";
import {
  SiAnsible, SiApachekafka, SiAppwrite, SiDocker, SiFirebase, SiFlutter, SiGit, SiJavascript, SiJenkins,
  SiJira, SiKubernetes, SiLinux, SiMysql, SiRabbitmq, SiRedis, SiSpringboot,
  SiTerraform
} from "react-icons/si";
  ...
  return (
    <div className=" border-neutral-800 pb:24">
      ...
      >
        ...
        <motion.div
          variants={iconVariants(2.5, 15)}
          initial="initial"
          animate="animate"
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          {/* RabbitMQ – #FF6600 */}
          <SiRabbitmq size={50} className="text-[#FF6600]" />
        </motion.div>
        ...
        >
          {/* Flutter – #02569B */}
          <SiFlutter size={50} className="text-[#02569B]" />
        </motion.div>
        ...
        >
          {/* Firebase – #FFCA28 */}
          <RiFirebaseFill size={50} className="text-[#FFCA28]" />
        </motion.div>
        ...
        >
          {/* Appwrite – #F02E65 */}
          <SiAppwrite size={50} className="text-[#F02E65]" />
        </motion.div>
